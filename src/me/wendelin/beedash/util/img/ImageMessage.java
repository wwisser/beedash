package me.wendelin.beedash.util.img;
...
public class ImageMessage {
    ...
    private final Color[] colors = {new Color(0, 0, 0), new Color(0, 0, 170),
            new Color(0, 170, 0), new Color(0, 170, 170), new Color(170, 0, 0),
            new Color(170, 0, 170), new Color(255, 170, 0),
            new Color(170, 170, 170), new Color(85, 85, 85),
            new Color(85, 85, 255), new Color(85, 255, 85),
            new Color(85, 255, 255), new Color(255, 85, 85),
            new Color(255, 85, 255), new Color(255, 255, 85),
    ...
    public ImageMessage appendCenteredText(String... text) {
        for (int y = 0; y < lines.length; y++) {
            if (text.length > y) {
                int len = ChatPaginator.AVERAGE_CHAT_PAGE_WIDTH
                        - lines[y].length();
    ...
    private ChatColor[][] toChatColorArray(BufferedImage image, int height) {
        ...
        BufferedImage resized = resizeImage(image, (int) (height / ratio),
                height);
        ChatColor[][] chatImg = new ChatColor[resized.getWidth()][resized
                .getHeight()];
    ...
    private BufferedImage resizeImage(BufferedImage originalImage, int width,
        ...
        af.scale(width / (double) originalImage.getWidth(), height
